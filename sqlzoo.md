...
#Table of Contents
[Main Page](https://github.com/asantos3026/lisa-aileen-sql/blob/master/sqlzoo.md)<br><br>
...
```
SELECT COUNT(teacher.name) AS num_teachers, COUNT(teacher.mobile) AS num_phones FROM teacher
```
